...
public class TestDAGPlan {
  ...
  public void testInvalidJavaOpts() {
    ...
    try {
      DAGPlan dagProto = dag.createDag(conf, null, null, null, true, new JavaOptsChecker());
    ...
    conf.set(TezConfiguration.TEZ_TASK_LAUNCH_CMD_OPTS, "  -XX:-UseParallelGC ");
    DAGPlan dagProto1 = dag.createDag(conf, null, null, null, true, new JavaOptsChecker());
